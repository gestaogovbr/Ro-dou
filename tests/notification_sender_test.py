...
class TestNotificationSenderSend:
    ...
    def test_send_with_header(
        self, mock_apprise_class, mock_report_config, sample_search_report
    ):
    ...
    def test_send_without_header(
        self,
        mock_apprise_class,
        mock_report_config_no_header_footer,
        sample_search_report,
    ):
        mock_apprise_instance = MagicMock()
        mock_apprise_class.return_value = mock_apprise_instance
    ...
    def test_send_with_empty_report(
        self, mock_apprise_class, mock_report_config, empty_search_report
    ):
        mock_apprise_instance = MagicMock()
        mock_apprise_class.return_value = mock_apprise_instance
...
class TestNotificationSenderProcessSearchSection:
    ...
    def test_process_search_section_with_header(self, mock_report_config):
        ...
        search = {
            "header": "Seção 3",
            "result": {"group_1": {"term_1": {"Department A": []}}},
        }
    ...
    def test_process_search_section_without_header(self, mock_report_config):
        sender = NotificationSender(mock_report_config)
        search = {"result": {"group_1": {"term_1": {"Department A": []}}}}
...
class TestNotificationSenderProcessGroup:
    ...
    def test_process_group_with_filters_visible(self, mock_report_config):
        ...
        search_results = {"term_1": {"Department A": []}}
...
class TestNotificationSenderProcessTermResults:
    ...
    def test_process_term_results_empty_with_filters_hidden(
        self, mock_report_config_no_header_footer
    ):
        sender = NotificationSender(mock_report_config_no_header_footer)
        term = "empty_term"
...
class TestNotificationSenderSendText:
    ...
    @patch("dags.ro_dou_src.notification.notification_sender.apprise.Apprise")
    def test_send_text_without_footer(
        self, mock_apprise_class, mock_report_config_no_header_footer
    ):
        mock_apprise_instance = MagicMock()
        mock_apprise_class.return_value = mock_apprise_instance
...
class TestNotificationSenderIntegration:
    ...
    def test_notification_with_highlighting_placeholders(
        self, mock_apprise_class, mock_report_config
    ):
        mock_apprise_instance = MagicMock()
        mock_apprise_class.return_value = mock_apprise_instance
...
class TestNotificationSenderEdgeCases:
        ...
        nested_empty_report = [
            {
                ...
                "result": {
                    "group_1": {},
                    "group_2": {"term_1": {}, "term_2": {"Department A": []}},
                },
            }
        ]
    ...
    @patch("dags.ro_dou_src.notification.notification_sender.apprise.Apprise")
    def test_send_data_with_different_data_types(
        self, mock_apprise_class, mock_report_config
    ):
        mock_apprise_instance = MagicMock()
        mock_apprise_class.return_value = mock_apprise_instance
