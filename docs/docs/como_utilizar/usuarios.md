...
* fonte(s) de pesquisa desejada(s): DOU, INLABS, Querido Diário (diários oficiais de municípios).
...
* interesse em receber o texto completo da publicação ou a ementa, em vez do trecho resumido
* interesse na geração de resumos automáticos das publicações com uso de Inteligência Artificial
* interesse em exibir a relevância (classificação) de cada publicação encontrada
...
* interesse em receber as notificações também em outros canais, como Slack, Discord.
