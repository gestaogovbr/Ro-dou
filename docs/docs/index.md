...
Neste site, você encontrará informações sobre como usar o Ro-DOU e quais funcionalidades ele proporciona, além de outras informações sobre como contribuir para melhorar a ferramenta e como contatar o MGI. Para começar agora, veja como fazer a [instalação e configuração](como_utilizar/instalacao.md).
