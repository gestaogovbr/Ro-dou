...
# def send_notification(specs: DAGConfig,
#                       search_report: str,
#                       report_date: str):
...
#     else:
#         _send_email(specs, search_report, report_date)


# def _send_email(specs: DAGConfig, search_report: dict, report_date):
...
#     if items:
#         content = generate_email_content(search_report)
#     else:
#         if specs.skip_null:
...
#         with get_csv_tempfile(search_report) as csv_file:
#             send_email(
#                 to=specs.emails,
...
# def generate_email_content(search_report: dict) -> str:
...
# def get_csv_tempfile(search_report: dict) -> NamedTemporaryFile:
#     temp_file = NamedTemporaryFile(prefix='extracao_dou_', suffix='.csv')
#     convert_report_to_dataframe(search_report).to_csv(temp_file, index=False)
#     return temp_file


# def convert_report_to_dataframe(search_report: dict) -> pd.DataFrame:
#     df = pd.DataFrame(convert_report_dict_to_tuple_list(search_report))
...
# def convert_report_dict_to_tuple_list(search_report: dict) -> list:
#     tuple_list = []
#     for group, results in search_report.items():
